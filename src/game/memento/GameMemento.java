...
public class GameMemento {
 ...
 // Button states
    ...
    private boolean regenButtonEnabled = true;
 ...
 // Button state getters and setters
    ...
    public boolean isRegenButtonEnabled() {
        return regenButtonEnabled;
    }

    public void setRegenButtonEnabled(boolean regenButtonEnabled) {
        this.regenButtonEnabled = regenButtonEnabled;
    }
